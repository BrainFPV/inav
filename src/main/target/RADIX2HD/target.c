...
timerHardware_t timerHardware[] = {
    ...
    DEF_TIM(TIM2,  CH1, PA15,  TIM_USE_OUTPUT_AUTO, 0,  2), // S3
    DEF_TIM(TIM2,  CH3, PA2,   TIM_USE_OUTPUT_AUTO, 0,  3), // S4
    ...
    DEF_TIM(TIM4,  CH3, PD14,  TIM_USE_OUTPUT_AUTO, 0,  7), // S8

    // Additional timer outputs using the UART6 pins
    DEF_TIM(TIM8,  CH1, PC6,   TIM_USE_OUTPUT_AUTO, 0,  0), // TX6 / S9
    DEF_TIM(TIM8,  CH2, PC7,   TIM_USE_OUTPUT_AUTO, 0,  0), // RX6 / S10
