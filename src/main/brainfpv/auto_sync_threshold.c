...
#define SYNC_TIP_VOLTAGE_MIN_CNT ((255 * SYNC_TIP_VOLTAGE_MIN_MV) / ADCVREF)
#define SYNC_TIP_VOLTAGE_MAX_CNT ((255 * SYNC_TIP_VOLTAGE_MAX_MV) / ADCVREF)

#define SYNC_TIP_HIST_LEN (SYNC_TIP_VOLTAGE_MAX_CNT - SYNC_TIP_VOLTAGE_MIN_CNT + 2)

extern adcDevice_t adcHardware[ADCDEV_COUNT];
...
int autoSyncThresholdInit(void)
{
    ...
    thAdcDevice.DmaHandle.Instance                 = thAdcDevice.DMAy_Streamx;
    thAdcDevice.DmaHandle.Init.Request             = thAdcDevice.channel;
