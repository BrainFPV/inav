...
function(pack_brainfpv_fw name)
    ...
    set(fw_packer_py "/shared/brainfpv/brainfpv_code/brainfpv_fw_packer/brainfpv_fw_packer/brainfpv_fw_packer.py")
    #set(elf_file "$<TARGET_FILE_DIR:${name}.elf>/$<TARGET_FILE_BASE_NAME:${name}.elf>")
    ...
    if (git_status STREQUAL "CLEAN")
        set(build_ver ${git_tag})
    else()
        set(build_ver "${FIRMWARE_VERSION}-D")
    endif()
