...
#define RESET_BOOTLOADER_FIRMWARE_UPDATE                4  // Bootloader request to flash stored firmware update
#define RESET_BOOTLOADER_FIRMWARE_ROLLBACK              5  // Bootloader request to rollback to stored firmware and config backup
#define RESET_BOOTLOADER_FIRMWARE_UPDATE_SUCCESS        6
#define RESET_BOOTLOADER_FIRMWARE_UPDATE_FAILED         7
#else
